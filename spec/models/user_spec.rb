...
describe User do
    ...
    before { @user = User.new(firstname: "Example", middlename: "M",
    ...
    describe "when middlename is not present" do
        before { @user.middlename = " " }
    ...
    describe "when middlename is too long" do
        before { @user.middlename = "a" * 51 }
        it { should_not be_valid }
    end
    ...
    describe "when password is not present" do
        before do
            @user = User.new(firstname: "Example", middlename: "M",
                             lastname: "User", email: "user@example.com",
